...
>
```html
<p id="ichiban">ここだけ特別（id: ichiban）</p>
  <p>ふつうの段落</p>
```
...
```css
/* .menu の中の a のうち、.genzai ではないものに hover したとき */
...
>
```html
<p class="aka">マウスを重ねると色が変わる（aka）</p>
  <p>ふつうの段落</p>
```
...
>
```html
<h2 class="midashi">見出し（midashi）</h2>
  <h2>ふつうの見出し</h2>
```
