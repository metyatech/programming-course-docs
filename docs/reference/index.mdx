...
| `<strong>` | 重要なテキスト | [テキスト](../html-basics/text-markup/index.mdx) |
| `<small>` | 補足説明（小さい文字） | [テキスト](../html-basics/text-markup/index.mdx) |
...
| `<footer>` | フッター部分 | [要素](../html-basics/elements/index.mdx) |
...
| `font-size` | 文字サイズ | `16px`, `1.5em`, `120%` | [テキストと文字](../css-basics/text-typography/index.mdx) |
| `text-align` | 文字の揃え | `left`, `center`, `right`, `justify` | [テキストと文字](../css-basics/text-typography/index.mdx) |
| `line-height` | 行の高さ | `1.5`, `24px` | [テキストと文字](../css-basics/text-typography/index.mdx) |
...
| `margin` (負) | 負のマージン | `-20px` | [負のマージン](../css-basics/negative-margin/index.mdx) |
...
| `background-repeat` | 背景の繰り返し | `no-repeat`, `repeat-x` | [背景](../css-basics/backgrounds/index.mdx) |
| `background-attachment` | スクロール時の動作 | `scroll`, `fixed`, `local` | [背景](../css-basics/backgrounds/index.mdx) |
| `background` | 背景の一括指定 | `url() center/cover no-repeat` | [背景](../css-basics/backgrounds/index.mdx) |
...
| `flex` | フレックスアイテムの伸縮 | `1`, `0 0 200px` | [Flexbox 応用](../css-basics/flexbox-advanced/index.mdx) |
...
| `text-shadow` | テキストの影 | `2px 2px 4px rgba(0,0,0,0.5)` | [装飾効果](../css-basics/decorative-effects/index.mdx) |
| `linear-gradient` | 線形グラデーション | `to right, red, blue` | [装飾効果](../css-basics/decorative-effects/index.mdx) |
| `radial-gradient` | 円形グラデーション | `circle, red, blue` | [装飾効果](../css-basics/decorative-effects/index.mdx) |

### アニメーション

| プロパティ・値 | 説明 | 例 | 詳細ページ |
|--------------|------|-----|-----------|
| `transition` | トランジション | `all 0.3s ease` | [アニメーション](../css-basics/css-animations/index.mdx) |
| `transform` | 変形 | `rotate(45deg)`, `scale(1.5)` | [アニメーション](../css-basics/css-animations/index.mdx) |
